...
<p align="left">
🎓 Ingeniero en Sistemas con enfoque en <strong>desarrollo de software, auditoría de sistemas y ciberseguridad</strong>.

💻 Experiencia en el diseño y desarrollo de aplicaciones web, principalmente con <strong>Angular, Node.js y Express</strong>, aplicando buenas prácticas de arquitectura, seguridad y mantenibilidad.

📂 He colaborado en <strong>proyectos como freelance y tenido la oportunidad de crear diversos proyectos personales y universitarios</strong>, orientados a la automatización de procesos, gestión de información y desarrollo de soluciones web funcionales y escalables.

📈 Comprometido con el aprendizaje continuo, la mejora técnica y la creación de soluciones con impacto real.

🔐 Además de un interés constante en <strong>seguridad informática, auditoría de TI, análisis de riesgos y mejora de procesos</strong>.
